          ...
          <div className="w-full md:w-2/3">
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-4">
                <Badge variant="success">Pengepul Aktif</Badge>
                {collector.categories?.name && (
                  <Badge variant="neutral">Kategori: {collector.categories.name}</Badge>
                )}
              </div>
              <h1 className="text-display-lg text-text-primary mb-2">{collector.name}</h1>
            ...
            <Card className="mb-6" variant="default">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="text-body-sm font-bold text-text-primary mb-1 flex items-center gap-2">
